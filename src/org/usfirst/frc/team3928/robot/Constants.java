...
public class Constants
{
    ...
    public static final int DRIVE_RIGHT_1_POWER_CHANNEL = 2;
    public static final int DRIVE_RIGHT_2_POWER_CHANNEL = 3;
    public static final int DRIVE_LEFT_1_POWER_CHANNEL = 0;
    public static final int DRIVE_LEFT_2_POWER_CHANNEL = 1;
    ...
    //Gear Manipulator
    public static final int GEAR_SOLENOID_FLAP_A_CHANNEL = 0; // TODO
    public static final int GEAR_SOLENOID_A_CHANNEL = 1; // TODO
    public static final int GEAR_SOLENOID_FLAP_B_CHANNEL = 2; // TODO
    public static final int GEAR_SOLENOID_B_CHANNEL_1 = 3; // TODO

    //Intake
    public static final int INTAKE_SOLENOID_A_CHANNEL = 4; // TODO
    public static final int INTAKE_SOLENOID_B_CHANNEL = 5; // TODO
    public static final int INTAKE_POWER_CHANNEL = 4;
    ...
    public static final double ELEVATOR_SHOOT_SPEED = .5; //TODO
    public static final double ELEVATOR_INTAKE_SPEED = .5; //TODO
    ...
    //Climber
    public static final int CLIMBER_CHANNEL = 8; //TODO
    ...
    public static final int BUTTON_GEAR_TOGGLE_GEAR = 2; //x
    public static final int BUTTON_CLIMBER = 0; //XBox button
    public static final int BUTTON_FLAP = 10; //R Tigger
